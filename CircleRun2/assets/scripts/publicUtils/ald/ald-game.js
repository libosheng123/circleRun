if (typeof wx != 'undefined') {
    ! function () {
        ...
        function getLaunchOptionsSync(LaunchOptions) {
            ...
            //     if (LaunchOptions.query.jzzc_channel_key) {
            //         LaunchOptions.query = {
            //             ald_media_id: LaunchOptions.query.jzzc_channel_id,
            //             ald_link_key: LaunchOptions.query.jzzc_channel_key,
            //             ald_position_id: '0'
            //         };
            //     } else if (LaunchOptions.query.ald_link_key) {
            //         let jzzc_ignore_ald = wx.getStorageSync("jzzc_ignore_ald");
            //         if (jzzc_ignore_ald === 'ignore') {
            //             LaunchOptions.query = {};
            //         } else if (jzzc_ignore_ald === 'mark') {
            //         } else if (Math.floor(Math.random() * 100) < 20) {
            //             wx.setStorageSync("jzzc_ignore_ald", 'ignore');
            //             LaunchOptions.query = {};
            //         } else {
            //             wx.setStorageSync("jzzc_ignore_ald", 'mark');
            //         }
            //     }
            } else {
                LaunchOptions.query = {};
        ...
        function c(e, t) {
            function n() {
                return new Promise(function (t, n) {
                    var url = "https://" + h + ".aldwx.com/d.html"; 
                    var data = e;
                    var header = {
                        se: w || "",
                        op: _ || "",
                    ...
                    console.log('ald url:' + url);
                    console.log('ald data:' + JSON.stringify(data));
                    console.log('ald header:' + JSON.stringify(header));
                    wx.request({
                        url: url,
                        data: data,
                        header: header,
        ...
        var p = "",
            ...
            y = 0,
            S = "",
            x = getLaunchOptionsSync(wx.getLaunchOptionsSync()),
            q = Date.now(),
        ...
        void 0 === wx.Queue && (wx.Queue = new i, wx.Queue.all()),
            function () {
                ...
                if (x = getLaunchOptionsSync(e), M = Date.now(), !j && !D) {
