// 全屏激励广告
const rewardedAD_ID = "adunit-71ccb333c80d46e1";
// 插屏广告
const interstitialAD_ID = "adunit-c0bf276e33657fb2";
// banner广告
const bannerAD_ID = "adunit-b57a9156b5f35b4c";

var wxAdUtil = cc.Class({
  properties: {
  },
  ctor() {
  },
  ...
  showInterstitialAd () {
    if (wx.createInterstitialAd) {
      ...
      this.interstitialAd = wx.createInterstitialAd({adUnitId: interstitialAD_ID});
